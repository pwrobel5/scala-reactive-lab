...
trait JsonSupport extends SprayJsonSupport with DefaultJsonProtocol {
  implicit val nameFormat: RootJsonFormat[HelloWorldAkkaHttpServer.Name] = jsonFormat1(HelloWorldAkkaHttpServer.Name)
  implicit val greetingsFormat: RootJsonFormat[Greetings] = jsonFormat1(HelloWorldAkkaHttpServer.Greetings)
